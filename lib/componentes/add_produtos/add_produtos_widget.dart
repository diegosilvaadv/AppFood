...
class _AddProdutosWidgetState extends State<AddProdutosWidget>
  ...
  void initState() {
    ...
    _model.projectURLController1 ??= TextEditingController();
    _model.projectURLController2 ??= TextEditingController();
    setupAnimations(
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 0.0, 12.0),
                                  child: TextFormField(
                                    controller: _model.projectURLController1,
                                    autofocus: true,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      labelText: 'Valor',
                                    ...
                                    keyboardType:
                                        const TextInputType.numberWithOptions(
                                            decimal: true),
                                    validator: _model
                                        .projectURLController1Validator
                                        .asValidator(context),
                                  ),
                                ),
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 0.0, 12.0),
                                  child: TextFormField(
                                    controller: _model.projectURLController2,
                                    autofocus: true,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                    ...
                                    keyboardType:
                                        const TextInputType.numberWithOptions(
                                            decimal: true),
                                    validator: _model
                                        .projectURLController2Validator
                                        .asValidator(context),
                                  ),
                                ),
                                Row(
                                          ...
                                          onPressed: () async {
                                            await ProdutosTable().insert({
                                              ...
                                              'valor': double.tryParse(_model
                                                  .projectURLController1.text),
                                              'valor_promo': double.tryParse(
                                                  _model.projectURLController2
                                                      .text),
                                              'descricao': _model
